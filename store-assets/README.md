...
| `privacy-policy.md` | Complete privacy policy to host at `https://www.beauty-diagram.com/privacy` before submitting |
...
3. **Host the privacy policy** — publish the content of `privacy-policy.md` at `https://www.beauty-diagram.com/privacy` and verify the URL is publicly accessible before uploading the extension.
